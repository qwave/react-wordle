...
import iImage from '../assets/images/letters/i.png'
import eImage from '../assets/images/letters/e.png'
import cImage from '../assets/images/letters/c.png'
import xImage from '../assets/images/letters/x.png'
import pyaImage from '../assets/images/letters/pya.png'
            ...
            <div className='rules__section-wrapper'>
              <div className='rules__section'>
                <div className='rules__background'>
                  <Image src={iImage} className='rules__background-image rules__background-image--i'/>
                </div>
              ...
              <div className='rules__section'>
                <div className='rules__background'>
                  <Image src={cImage} className='rules__background-image rules__background-image--c'/>
                </div>
              ...
              <div className='rules__section'>
                <div className='rules__background'>
                  <Image src={xImage} className='rules__background-image rules__background-image--x'/>
                  <Image src={pyaImage} className='rules__background-image rules__background-image--pya'/>
                </div>
