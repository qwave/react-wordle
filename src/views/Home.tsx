        ...
        <Container fluid>
          <div className='welcome'>
            <div className='main__text'>
              <p>Недавно мы вместе перезапустили наши продуктовые линейки для котят и щенков: формулы стали еще более эффективными, а коммуникация с потребителем – понятнее. Продукт быстро появился на реальных и виртуальных полках наших партнеров, а Customer Care начали получать первые отзывы от покупателей. Но впереди нас ждет еще много челленджей!<br/>
              Поэтому нам так важна энергия, ум, быстрота и эрудиция каждого сотрудника.</p>
              <p>Чтобы потренировать все эти навыки, мы предлагаем тебе сыграть в нашумевшую игру Wordle.</p>
              <p>Игра продлится <strong>14 дней</strong>, каждый день тебе будет доступен новый раунд.<br/><strong>Войди в ТОП-5 игроков</strong> и получи приз!</p>
            </div>
